 ...
 * @author basirudin
 */
public class controller_paket2 {

    private view_paket3jam theView;
...
//    static int biaya = 0;
    ...
    public controller_paket2(String username) throws SQLException {
        this.username = username;
        theModel = new model();
        theView = new view_paket3jam();
                ...
                for (;;) {
                    if (kondisi = true) {
                        try {
                            ...
                            biayaString = Integer.toString(theModel.selectPaket2());
